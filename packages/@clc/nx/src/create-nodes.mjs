...
/** @typedef {import('@nx/devkit').CreateNodesV2} CreateNodesV2 */
/** @typedef {import('@nx/devkit').TargetConfiguration} TargetConfiguration */

/**
 * @type {Parameters<createNodesFromFiles>[0]}
 */
// eslint-disable-next-line complexity
const createNode = async (projectConfigurationFile) => {
...
export const createNodesV2 = [
  ...
  async (configFiles, options, context) =>
    createNodesFromFiles(createNode, configFiles, options, context),
];
